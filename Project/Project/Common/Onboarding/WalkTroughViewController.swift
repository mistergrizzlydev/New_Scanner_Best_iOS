...
final class WalkTroughViewController: UIViewController {
  ...
  private func setupViews() {
    ...
    skipButton.translatesAutoresizingMaskIntoConstraints = false // Set this to false to use constraints
    skipButton.isHidden = true
    ...
    // Add constraints to position the button in the top-right corner
  ...
  @objc private func skipButtonTapped(_: UIButton) {
    print(#function)
  }
}
...
extension WalkTroughViewController: PaperOnboardingDelegate {
...
extension WalkTroughViewController: PaperOnboardingDataSource {
