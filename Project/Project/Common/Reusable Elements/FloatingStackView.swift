...
final class FloatingStackView: UIStackView {
    ...
    private func setupButtons() {
        ...
        cameraButton.setImage(UIImage(systemName: "camera.fill", withConfiguration: imageConfig), for: .normal)
        ...
        galleryButton.setImage(UIImage(systemName: "photo.fill", withConfiguration: imageConfig), for: .normal)
