...
final class EditScanViewController: UIViewController {
  ...
  private lazy var nextButton: UIBarButtonItem = {
    return UIBarButtonItem(title: "Next", style: .plain, target: self, action: #selector(pushReviewController))
  }()
  
  private lazy var cancelButton: UIBarButtonItem = {
    return UIBarButtonItem(title: "Cancel", style: .plain, target: self, action: #selector(cancelButtonTapped))
  }()
