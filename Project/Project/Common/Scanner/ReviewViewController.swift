...
final class ReviewViewController: UIViewController {
  ...
  private lazy var enhanceButton: UIBarButtonItem = {
    let image = UIImage(systemName: "wand.and.rays.inverse")
  ...
  private lazy var rotateButton: UIBarButtonItem = {
    let image = UIImage(systemName: "rotate.right")
...
//        UIToolbar.appearance().tintColor = .bgColor
  ...
  @objc func toggleEnhancedImage() {
    ...
    if isCurrentlyDisplayingEnhancedImage {
      enhanceButton.image = UIImage(systemName: "wand.and.rays")
    } else {
      enhanceButton.image = UIImage(systemName: "wand.and.rays.inverse")
    }
  }
