...
open class TextFieldTagView: UIView, UITextInputTraits {
    ...
    internal var onDidRequestDelete: ((_ tagView: TextFieldTagView, _ replacementText: String?) -> Void)?
    internal var onDidRequestSelection: ((_ tagView: TextFieldTagView) -> Void)?
    internal var onDidInputText: ((_ tagView: TextFieldTagView, _ text: String) -> Void)?
...
extension TextFieldTagView: UIKeyInput {
